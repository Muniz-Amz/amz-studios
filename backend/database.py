...
AUTOMACOES_PADRAO = [
    ...
    {"id": "roleAnnouncement", "title": "Mensagem de anuncio", "description": "Filtra membros por cargo e envia um anuncio bonito no privado e/ou em um canal selecionado.", "enabled": False, "type": "role-announcement", "values": {"roleId": "", "roleIdName": "", "channelId": "", "channelIdName": "", "title": "Comunicado importante", "message": "Ola {user}, temos um novo aviso para quem possui o cargo {role}.", "color": "#35d8ff", "imageUrl": "", "footer": "AMZ Studios", "sendChannel": True, "sendDm": True, "includeBots": False, "maxRecipients": 50, "safeMode": True, "batchSize": 5, "batchPauseSeconds": 15, "dmDelaySeconds": 2}},
