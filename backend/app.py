...
def montar_status_configuracoes():
    variaveis = (
        ...
        "AMZ_CLEANUP_MAX_CHANNELS_PER_RUN",
        "AMZ_CLEANUP_DELETE_DELAY_SECONDS",
        "AMZ_CLEANUP_CHANNEL_DELAY_SECONDS",
        "AMZ_CLEANUP_RATE_LIMIT_BACKOFF_SECONDS",
        "AMZ_CLEANUP_CHANNEL_FAILURE_LIMIT",
        "AMZ_CLEANUP_CHANNEL_LOCK_SECONDS",
